...
> Русскоязычная вводная документация для форка `agency-agents`. Это первый этап локализации: команды, пути, имена skill/subagent и технические идентификаторы намеренно оставлены на английском ради совместимости.
