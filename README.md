...
> Русскоязычная вводная документация для форка `agency-agents`. Это README по умолчанию для GitHub: команды, пути, имена skill/subagent и технические идентификаторы намеренно оставлены на английском ради совместимости.
